...
export default function Card(){
    return <>
    <div class="w-[300px] rounded-md  dark:bg-black bg-white dark:border-black">
  <img
  ...
  />
  <div class="p-4">
    <h1 class="inline-flex items-center text-black text-lg font-semibold dark:text-white">
      About Macbook  {" "}
      <svg
